    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=[
                ...
                # Gazebo switches its clock to the world-qualified topic when
                # another /clock publisher exists. Bridge that source in the
                # Gazebo -> ROS direction only, then remap it to ROS /clock.
